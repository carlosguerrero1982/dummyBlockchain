...
public class Blockchain {
    ...
    private Block generateGenesis(){
        Block genesis = new Block("0x200",new java.util.Date(),"<transaction>");
    ...
    public void displayChain(){
        for(int i=0;i<chain.size();i++){
            ...
            System.out.println("Previous " + chain.get(i).getPreviousHash());
            System.out.println("Time " +  chain.get(i).getTimestamp());
